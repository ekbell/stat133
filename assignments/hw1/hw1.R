...
#check that it is equal to mean(m)
...
sd.m <- sqrt((sum((m - mean.m)^2)/99))

#check that it is equal to sd(m)
...
# << bmi >> : a vector with the BMI of each family member family 
